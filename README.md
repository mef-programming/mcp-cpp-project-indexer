...
```text
Show all modules under uiframework.Core.Direct2D.
```

```text
Which modules import SmartFTP.Shell.Browser:Impl?
```
...
```text
Read all overloads of GetAccessibleImpl.
```

```text
Which file defines uiframework.Elements:ElementImpl?
```
